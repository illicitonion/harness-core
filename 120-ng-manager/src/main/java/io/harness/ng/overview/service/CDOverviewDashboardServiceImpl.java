...
public class CDOverviewDashboardServiceImpl implements CDOverviewDashboardService {
  ...
  private Map<String, Pair<String, AuthorInfo>> getPipelineExecutionIdToTriggerTypeAndAuthorInfoMapping(
      ...
      if (totalDeployment > 0) {
        ...
        LastWorkloadInfo lastWorkloadInfo =
            LastWorkloadInfo.builder()
                ...
                .status(lastStatus)
                .triggerType(pipelineExecutionIdToTriggerAndAuthorInfoMap.get(pipelineExecutionId).getKey())
                .authorInfo(pipelineExecutionIdToTriggerAndAuthorInfoMap.get(pipelineExecutionId).getValue())
