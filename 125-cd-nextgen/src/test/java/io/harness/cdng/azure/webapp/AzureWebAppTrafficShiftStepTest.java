...
public class AzureWebAppTrafficShiftStepTest extends CategoryTest {
  ...
  public void testValidateResources() {
    ...
    azureWebAppTrafficShiftStep.validateResources(ambiance, stepElementParameters);
    ...
    assertThat(entityDetails.get(0).getEntityRef().getAccountIdentifier()).isEqualTo("account");
  }
