...
public class FileStoreClientFactoryForCg implements Provider<FileStoreNgClient> {
  ...
  public FileStoreClientFactoryForCg(String baseUrl, String serviceSecret, ServiceTokenGenerator serviceTokenGenerator) {
  ...
  public FileStoreNgClient get() {
    ...
    Retrofit retrofit = new Retrofit.Builder()
                            ...
                            .build();
    return retrofit.create(FileStoreNgClient.class);
  }
