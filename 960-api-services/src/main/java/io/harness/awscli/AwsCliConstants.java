...
public class AwsCliConstants {
  ...
  public static final String SET_CONFIGURE_COMMAND =
      "aws configure set " + CONFIGURE_OPTION + " " + CONFIGURE_VALUE + " --profile " + CONFIGURE_PROFILE;

  public static final String STS_COMMAND = "aws sts assume-role --role-arn " + ROLE_ARN + " --role-session-name "
      + ROLE_SESSION_NAME ;
}
